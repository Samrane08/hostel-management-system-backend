...
builder.Services.AddSingleton<BankBackgroundService>();
builder.Services.AddHostedService(provider => provider.GetRequiredService<BankBackgroundService>());
...
builder.Services.AddHttpClient("PFMSClient");
...
builder.Services.Configure<PFMSConfig>(builder.Configuration.GetSection(nameof(PFMSConfig)));
builder.Services.AddTransient<PFMSService>();
