...
public class ProfileService : IProfileService
{
    ...
    public async Task<PersonalDetailsModel> SavePersonalDetails(PersonalDetailsModel model)
    {
        try
        {
            ...
            param.Add("p_DisablePercentage", model.DisablePercentage, DbType.Int32);
            param.Add("p_IsIncomeDeclare", model.IsIncomeDeclare, DbType.Boolean);
            param.Add("p_IncomeAmount", model.IncomeAmount, DbType.String);
    ...
    public async Task<List<ViewDocumentModel>> GetUploadDocuments(int ? p_DeptId)
    {
        try
        {
            var param = new DynamicParameters();
            param.Add("p_UserId", currentUserService.UserNumericId, DbType.Int64);
            param.Add("p_DeptId", p_DeptId, DbType.Int32);
    ...
    public async Task<bool> InstallmentDocumentUpload(DocumentUploadModel model)
    {
        try
        {
            var param = new DynamicParameters();
            ...
            param.Add("p_UserId", currentUserService.UserNumericId, DbType.Int64);
            param.Add("p_CreatedBy", currentUserService.UserId, DbType.String);
            var result = await Task.FromResult(dapper.Execute("usp_UploadInstallmentDocuments", param, commandType: CommandType.StoredProcedure));
            return true;
        }
        catch (Exception ex)
        {
            // ExceptionLogging.LogException(Convert.ToString(ex));
            await errorLogger.Log("usp_UploadInstallmentDocuments", ex);
            return false;
        }
    }

    public async Task<AddressDetailsModel> GetAddressDetails(int caller)
    {
        try
        {
            var myParams = new DynamicParameters();
            myParams.Add("p_UserId", currentUserService.UserNumericId, DbType.Int64);
            myParams.Add("p_caller", caller, DbType.Int32);
      ...
      public async Task<string> SaveAddressDetails(AddressDetailsModel model)
       {
        try
        {
            var param = new DynamicParameters();
            ...
            param.Add("p_PresentTypeofPremises", model.PresentTypeofPremises, DbType.Int16);
            param.Add("p_PresentHouseOwnerName", model.PresentHouseOwnerName, DbType.String);
            param.Add("p_PresentOwnerMobileNo", model.PresentOwnerMobileNo, DbType.String);
            param.Add("p_UserId", currentUserService.UserNumericId, DbType.Int64);
            param.Add("p_CreatedBy", currentUserService.UserId, DbType.String);
            var result = await Task.FromResult(dapper.Insert<string>("usp_UpsertApplicantAddressDetails", param, commandType: CommandType.StoredProcedure));
            return result;
        }
        catch (Exception ex)
        {
    ...
    public async Task<ParentAddressModel> GetParentAddressDetails(int caller)
    {
        try
        {
            var myParams = new DynamicParameters();
    ...
    public async Task<string> SaveParentAddressDetails(ParentAddressModel model)
    {
        try
        {
            var param = new DynamicParameters();
            ...
            param.Add("p_UserId", currentUserService.UserNumericId, DbType.Int64);
            param.Add("p_CreatedBy", currentUserService.UserId, DbType.String);
            var result = await Task.FromResult(dapper.Insert<string>("usp_UpsertApplicantParentAddressDetails", param, commandType: CommandType.StoredProcedure));
            return result;
        }
        catch (Exception ex)
        {
    ...
    public async Task<string> SaveOtherDetails(OtherDetailsModel model)
    {
        try
        {
            var param = new DynamicParameters();
            ...
            param.Add("p_AreYouSalariedOrSelfEmployed", model.AreYouSalariedOrSelfEmployed, DbType.Int16);
            param.Add("p_DoYouDoAnyKindOfBusiness", model.DoYouDoAnyKindOfBusiness, DbType.Int16);
            ...
            param.Add("p_UserId", currentUserService.UserNumericId, DbType.Int64);
            param.Add("p_CreatedBy", currentUserService.UserId, DbType.String);
            var result = await Task.FromResult(dapper.Insert<string>("usp_UpsertApplicantOtherDetails", param, commandType: CommandType.StoredProcedure));
            return result;
        }
        catch (Exception ex)
        {
        ...
        try
        {
            ...
            if (result.Count > 0)
            {
                ...
                if (result[2] != null)
                {
                    ...
                    response.CasteDetails = JsonConvert.DeserializeObject<CastDetailsPreviewModel>(data);
                ...
                if (result[4] != null)
                {
                    ...
                    response.PresentAddress = JsonConvert.DeserializeObject<AddressDetailsPreviewModel2>(data);
                }
                if (result[5] != null)
                {
    ...
    public async Task<ApplicationModel?> HostelApply()
    {
        try
        {
            
               string ApplicationId = await ApplicationIdGenerator();
    ...
    public async Task<string?> CancelApplicationByApplicant(Int64 applicationId)
    {
        try
        {
            var param = new DynamicParameters();
    ...
    public async Task<PreviewModel> ApplicationDetails(long AppId)
    {
        ...
        {
            // ExceptionLogging.LogException(Convert.ToString(ex));
            await errorLogger.Log("usp_Application_Details_View", ex);
        }
        return response;
    }
    ...
    public async Task<bool> InstallmentDocFinalSubmit(InstallmentDocFinalSubmitModel model)
    {
        try
        {
            var param = new DynamicParameters();
            param.Add("p_DocId", model.p_DocId, DbType.String);
            param.Add("p_UserId", currentUserService.UserNumericId, DbType.Int64);
            param.Add("p_ApplicationId", model.p_ApplicationId, DbType.Int64);
            var result = await Task.FromResult(dapper.Get<string>("usp_InstallmentDocFinalSubmit", param, commandType: CommandType.StoredProcedure));
            return true;
        }
        catch (Exception ex)
        {
            // ExceptionLogging.LogException(Convert.ToString(ex));
            await errorLogger.Log("usp_InstallmentDocFinalSubmit", ex);
            return false;
        }
    }


    public DbtApplicantStatusModel CheckApplicantDataAvailbility(string academicYear)
    {
        try
        {
            var param = new DynamicParameters();
            ...
            var result = dapper.Get<DbtApplicantStatusModel>("usp_CheckApplicationPreFilledData", param, commandType: CommandType.StoredProcedure);
    ...
    public async Task<string> ValidatePreviewData()
    {
        try
        {
            var param = new DynamicParameters();
            ...
            string result = dapper.Get<string>("usp_ValidatePreviewData", param, commandType: CommandType.StoredProcedure);
            return result;
        }catch(Exception ex)
        {
            throw ex;
    ...
    public async Task<List<ApplicationCommonModel>?> GetApplicationListAtCommonDesk()
    {
        try
        {
            var appList = new List<ApplicationCommonModel>();
            var hostelList = new List<ApplicationModel2>();
            var myParams = new DynamicParameters();
            myParams.Add("p_UserId", currentUserService.UserNumericId, DbType.Int64);
            var result = await dapper.MultiResult("usp_ApplicationStatusAtCoomonDashboard", myParams, commandType: CommandType.StoredProcedure);
            ...
            if (result.Count > 0)
            {
                ...
                {
                    var data = JsonConvert.SerializeObject(result[0].ToList());
                    appList = JsonConvert.DeserializeObject<List<ApplicationCommonModel>>(data);
                }
        ...
        {
            // ExceptionLogging.LogException(Convert.ToString(ex));
            await errorLogger.Log("usp_ApplicationStatusAtCoomonDashboard", ex);
            return null;
        }
    }

    public async Task<bool> getCastewiseElgIbility(int? casteCategoruId)
    {
        try
        {
            var myParams = new DynamicParameters();
            myParams.Add("p_casteCategoryId", casteCategoruId, DbType.Int32);
           //  myParams.Add("p_deptId", deptId, DbType.Int32);

            //  bool rs = await Task.FromResult(dapper.Get<bool>("usp_CheckExistForCurrentYearAndService", param, commandType: CommandType.StoredProcedure));
            bool rs = await Task.FromResult(dapper.Get<bool>("usp_getCasteWiseEligibiltyVJNT", myParams, commandType: CommandType.StoredProcedure));
            return rs;
        }
        catch (Exception ex)
        {
            // ExceptionLogging.LogException(Convert.ToString(ex));
            await errorLogger.Log("usp_getCasteWiseEligibiltyVJNT", ex);
            throw;
        }
    }
}
