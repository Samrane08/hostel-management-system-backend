...
namespace Model
{
    ...
    public class PersonalDetailsPreviewModel
    {
        ...
        [DisplayName("Is Family Income Declare")]
        public string? IsIncomeDeclare { get; set; }
        [DisplayName("Family Amount")]
    ...
    public class CastDetailsPreviewModel
    {
        ...
        [DisplayName("Disable Percentage")]
        public string? DisablePercentage { get; set; }
        [DisplayName("Caste")]
    ...
    {
        [DisplayName("Is Maharashtra Domicile?")]
    ...
    public class AddressDetailsPreviewModel2
    {
        [DisplayName("Address 1")]
        public string? Address1 { get; set; }
        [DisplayName("Address 2")]
        ...
        public string? Village { get; set; }
        public string? Pincode { get; set; }
        [DisplayName("Type of Premises")]
        public string? TypeofPremises { get; set; }
        [DisplayName("House Owner Name")]
        public string? HouseOwnerName { get; set; }
        [DisplayName("House Owner Mobile No.")]
    ...
    public class CurrentCoursePreviewModel
    {
        ...
        [DisplayName("College Name / School name")]
