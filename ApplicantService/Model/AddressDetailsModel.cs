namespace Model
{
    public class AddressDetailsModel
    {
        ...
        public int? PresentTypeofPremises { get; set; }
        public string? PresentHouseOwnerName { get; set; } = "";
        public string? PresentOwnerMobileNo { get; set; } = "";

    }

    public class ParentAddressModel
    {
        public int? UserId { get; set; }
    ...
    {
        public AddressDetailsModel? AddressDetailsModel { get; set; }
        public ParentAddressModel? ParentAddressModel { get; set; }
        public List<CurrentCourseDetails?>CurrentCourseDetails {  get; set; }
       public List<EducationDetails?> PastCourseDetails {  get; set; }
    }
}
