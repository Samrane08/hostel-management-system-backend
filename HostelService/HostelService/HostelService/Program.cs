...
{
    c.SwaggerDoc("HostelService", new OpenApiInfo { Title = "Hostel Service API", Version = "v1" });
...
app.UseSwagger();
app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/HostelService/swagger.json", "My API Version: 1.0"));
